local thing = [[
	print('nObf: replace this line with your code.')
]]
...
print('nObf: setting file...')
file = io.open("nertigel_obfuscated.lua", "a")
print('nObf: file set.')
file:write(jcm..jcn1..jcq..'load("'..encoded..'")() '..jcq..jcn2..jcq)
print('nObf: file written successfully.')